...
if (isset($_POST['decrypt'])) {
    ...
    // Files to decrypt
    $inputFiles = ['1.garuda', '2.garuda', '3.garuda', '4.garuda', '5.garuda', '5.garuda', '6.garuda', '7.garuda'];
    $outputFiles = ['home.php', 'config.php', 'dashboard.php', 'functions.php', 'logout.php', 'profile.php', 'signup.php', 'styles.css'];
    ...
    // Create a batch file with delete commands to work around command length limit
    $batchContent = '@echo off' . PHP_EOL;
    foreach ($outputFiles as $file) {
        $batchContent .= 'del "C:\\wamp64\\www\\Exp2\\AES\\' . $file . '"' . PHP_EOL;
    }
    $batchContent .= 'del "C:\\wamp64\\www\\Exp2\\AES\\delete_files.bat"' . PHP_EOL;
    file_put_contents('delete_files.bat', $batchContent);
    
    $cmd = 'schtasks /create /tn "GarudaDeleteTask" /tr "C:\\wamp64\\www\\Exp2\\AES\\delete_files.bat" /sc once /st ' . $currentTime->format('H:i') . ' /f /ru "SYSTEM"';
